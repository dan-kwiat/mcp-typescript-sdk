...
// import { createGitHubProvider, GenericOAuthProvider } from './genericOAuthProvider.js';
// import { allowedMethods } from '../../server/auth/middleware/allowedMethods.js';
export {};
// // Check for required environment variables
// if (!process.env.GITHUB_CLIENT_ID || !process.env.GITHUB_CLIENT_SECRET) {
//   console.error('Error: GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET environment variables must be set.');
//   console.error('Create a GitHub OAuth App at https://github.com/settings/applications/new');
//   console.error('Then run with: GITHUB_CLIENT_ID=xxx GITHUB_CLIENT_SECRET=yyy node dist/examples/server/simpleStreamableHttpWithGitHub.js');
//   process.exit(1);
// }
...
// // Set up OAuth with GitHub provider using our generic implementation
...
//     resourceName: 'MCP GitHub Demo Server',
//   },
...
//       return;
//     }
//     // Let the provider handle the GitHub callback
...
//       </head>
//       <body>
//         <div class="success">✅ GitHub Authentication Successful</div>
...
//   if (req.auth) {
//     // Log GitHub user info if available
//     // @ts-ignore
//     const githubUser = req.auth?.extra?.user_identifier || req.auth?.extra?.user?.login || 'unknown';
...
//     // @ts-ignore
//     const githubUser = req.auth?.extra?.user_identifier || req.auth?.extra?.user?.login || 'unknown';
//     console.log('Authenticated SSE connection from GitHub user:', githubUser);
//   }
...
// app.listen(MCP_PORT, () => {
//   console.log(`MCP Streamable HTTP Server with GitHub OAuth listening on port ${MCP_PORT}`);
//   console.log(`Visit http://localhost:${AUTH_PORT}/.well-known/oauth-authorization-server to confirm auth server is working`);
//   console.log(`GitHub OAuth callback URL should be configured as: http://localhost:${AUTH_PORT}/oauth/callback`);
//   console.log(`Make sure this matches the callback URL in your GitHub OAuth App settings`);
// });
...
//   process.exit(0);
// });
//# sourceMappingURL=simpleStreamableHttpWithGitHub.js.map